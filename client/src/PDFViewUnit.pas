...
uses
  ...
  FMX.TreeView, System.Generics.Collections, System.Math, FMX.Ani, FMX.Effects;
...
type
  TPDFViewForm = class(TForm)
    ...
    SearchShadowEffect: TShadowEffect;
    HeaderShadowEffect: TShadowEffect;
    SearchPanelAniIn: TFloatAnimation;
    SearchPanelAniOut: TFloatAnimation;
    BookmarkPanelAniIn: TFloatAnimation;
    BookmarkPanelAniOut: TFloatAnimation;
    ...
    procedure SearchPanelAniOutFinish(Sender: TObject);
    procedure BookmarkPanelAniOutFinish(Sender: TObject);
    procedure BookmarkPanelAniInFinish(Sender: TObject);
    procedure FullSearchEditKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
      Shift: TShiftState);
  private
...
procedure TPDFViewForm.SearchPanelAniOutFinish(Sender: TObject);
begin
...
procedure TPDFViewForm.BookmarkPanelAniInFinish(Sender: TObject);
begin
  Zoom;
end;

procedure TPDFViewForm.BookmarkPanelAniOutFinish(Sender: TObject);
begin
...
begin
  ...
  //SearchPanel.Visible := false;
  SearchPanelAniOut.Start;
  //FPdfView.Margins.Top := 0;
end;

procedure TPDFViewForm.FullSearchEditKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
if Key = 13 then
  begin
    FullSearchNextButtonClick(PDFViewForm);
  end;
end;

...
uses logUnit, FMX.Platform, FMX.BehaviorManager;

//HELPERS
procedure TPDFViewForm.log(text: string);
begin
...
begin
  Label2.Text := IntToStr(FPdfView.PageNumber);
  Selecting := False;
  SelectionStart := -1;
  SelectionEnd := -1;
